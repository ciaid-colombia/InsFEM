module Mod_lmn_SubgridSpaceResidual
   use typre
...
contains
   ...
   subroutine AllocSGRes
      ...
      call a%Memor%alloc(a%ndofn,gpSubscaleSpaceResidual,'gpSubscaleSpaceResidual','lmn_EndElmope')
   end subroutine
   
   subroutine DeallocSGRes
      implicit none
      
      call a%Memor%dealloc(a%ndofn,gpSubscaleSpaceResidual,'gpSubscaleSpaceResidual','lmn_EndElmope')
   end subroutine
