...
!             use Mod_NavierStokes          
   ...
   write(*,*) 'supf_bouope_1stY: at this point, no statistics about wall law'
   ...
   boundaries: do iboun=1,nboun
      ...
      call supf_bouopeY(a,iboun,e,welmat,welrhs,a%ndofn,bcstart)    
...
end subroutine supf_bouope_1stY
