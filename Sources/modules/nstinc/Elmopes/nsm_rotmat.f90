subroutine nsm_rotmat(imodi,nnode,mnode,ndime,ndof,amatr,bvect,rotma)
!------------------------------------------------------------------------
!
...
end subroutine nsm_rotmat

subroutine nsm_rotmatInv(imodi,nnode,mnode,ndime,ndof,amatr,bvect,rotma)
!------------------------------------------------------------------------
!
! This routine modifies a matrix the components of which are
! submatrices by rotating them using a matrix R ( = ROTMA) as follows:
