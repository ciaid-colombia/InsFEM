module Mod_nsc_InterpolateResidualProjection
...
contains
   ...
   subroutine SetPointersInterpolateResidualProjection(itask)
      ...
      case(1)
         ...
         if (a%kfl_repro /= 0) then
               call ConcatenateProcedures(ProcHook_nsc_Initializations,AllocRep)
               call ConcatenateProcedures(ProcHook_nsc_Finalizations,DeallocRep)
               call ConcatenateProcedures(ProcHook_nsc_Gathers,GatherRep)
               call ConcatenateProcedures(ProcHook_nsc_Interpolates,InterpolateRep)
            endif
         endif
   ...
   subroutine AllocRep
      ...
      call a%Memor%alloc(a%ndofn,e%mnode,elrep,'elrep','nsc_Elmope_im')
      call a%Memor%alloc(a%ndofn,gprep,'gprep','nsc_Elmope_im')
   end subroutine
   
   subroutine DeallocRep
      implicit none
      
      call a%Memor%dealloc(a%ndofn,e%mnode,elrep,'elrep','nsc_Elmope_im')
      call a%Memor%dealloc(a%ndofn,gprep,'gprep','nsc_Elmope_im')
   end subroutine
...
module Mod_nsc_SubgridSpaceResidual
   use typre
   use Mod_nsc_BaseElmope
...
contains
   ...
   subroutine SetPointersComputeSubgridSpaceResidual(itask)
      ...
      case(1)
         ...
         !Allocations
         call ConcatenateProcedures(ProcHook_nsc_Initializations,AllocSGRes)
         call ConcatenateProcedures(ProcHook_nsc_Finalizations,DeallocSGres)
         ...
         !Compute the Residual at the Gauss point 
            ...
            if (a%kfl_repro == 0) then
               ...
               call ConcatenateProcedures(ProcHook_nsc_InGaussElmats,SubgridSpaceResidualASGS)
            elseif (a%kfl_repro /= 0) then
               ...
               call ConcatenateProcedures(ProcHook_nsc_InGaussElmats,SubgridSpaceResidualOSS)
            endif 
         endif 
   ...
   subroutine AllocSGRes
      ...
      call a%Memor%alloc(1,gpdSGSpaceResidual,'gpdSGSpaceResidual','nsc_EndElmope')
      call a%Memor%alloc(e%ndime,gpmSGSpaceResidual,'gpmSGSpaceResidual','nsc_EndElmope')
      call a%Memor%alloc(1,gpeSGSpaceResidual,'gpeSGSpaceResidual','nsc_EndElmope')
   end subroutine
   
   subroutine DeallocSGRes
      implicit none
      
      call a%Memor%dealloc(1,gpdSGSpaceResidual,'gpdSGSpaceResidual','nsc_EndElmope')
      call a%Memor%dealloc(e%ndime,gpmSGSpaceResidual,'gpmSGSpaceResidual','nsc_EndElmope')
      call a%Memor%dealloc(1,gpeSGSpaceResidual,'gpeSGSpaceResidual','nsc_EndElmope')
   end subroutine
