module Mod_sldsup_InterpolateResidualProjection
   use typre
...
contains
   ...
   subroutine AllocRep
      ...
      call a%Memor%alloc(a%ndofn,e%mnode,elrep,'elrep','sldsup_EndElmope')
      call a%Memor%alloc(a%ndofn,gprep,'gprep','sldsup_EndElmope')
   end subroutine
   
   subroutine DeallocRep
      implicit none
      
      call a%Memor%Dealloc(a%ndofn,e%mnode,elrep,'elrep','sldsup_EndElmope')
      call a%Memor%Dealloc(a%ndofn,gprep,'gprep','sldsup_EndElmope')
   end subroutine
   ...
   subroutine GatherRep
      ...
      call e%gather(a%ndofn,elrep,sup%repro)
   end subroutine
