subroutine sldsup_reanut(a,itask)
   ...
   if (itask == 0) then         !  Initializations (defaults)
       ...
       a%kfl_printDevStrain   = .false.   !Used to know how to print stress and strain
       a%kfl_useSecantModulus = .false.   !Used to know how to print stress and strain
   ...
   elseif (itask == 1) then     !Inside the Numerical Treatment Block   
       ...
       else if(words(1)=='SECAN') then

           if(words(2)=='ON   ') a%kfl_useSecantModulus = .true.
