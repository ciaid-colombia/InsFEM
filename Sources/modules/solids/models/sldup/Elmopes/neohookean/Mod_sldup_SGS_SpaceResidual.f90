module Mod_sldup_SubgridSpaceResidual
   use typre
...
contains
   ...
   subroutine AllocSGRes
      ...
      call a%Memor%alloc(a%ndofn,gpSubscaleSpaceResidual,'gpSubscaleSpaceResidual','sldup_EndElmope')
   end subroutine
   
   subroutine DeallocSGRes
      implicit none
      
      call a%Memor%dealloc(a%ndofn,gpSubscaleSpaceResidual,'gpSubscaleSpaceResidual','sldup_EndElmope')
   end subroutine
